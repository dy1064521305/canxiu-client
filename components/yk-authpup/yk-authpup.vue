			...
			return {
				...
				authList: {
					'WRITE_EXTERNAL_STORAGE': {
						title: "餐修品牌端对存储空间/照片权限申请说明",
						content: "便于您使用该功能上传您的照片/图片/视频及用于更换头像、意见反馈、保存相册、发布商品/分享、下载与客服沟通等场景中读取和写入相册和文件内容。"
					},
					'ACCESS_FINE_LOCATION': {
						title: "餐修品牌端对地理位置权限申请说明",
						content: "获取你的当前位置，用于推荐您所在区域可以购买的产品与/或服务"
					},
					'CAMERA':{
						title: "餐修品牌端对相机/摄像头权限申请说明",
						content: "我们访问您的相机是为了使您可以使用摄像头进行拍摄上传拍照的照片来做头像、订单完成等操作"
					},
					'RECORD_AUDIO':{
						title: "餐修品牌端对麦克风权限申请说明",
						content: "便于您使用该功能进行录音、语音通话、发布语音、与客服语音沟通等场景中使用"
					},
					'CALL_PHONE': {
						title: "餐修品牌端对拨打/管理电话权限申请说明",
						content: "用于给同事或客户拨打电话"
					}
				}
			}
		},
