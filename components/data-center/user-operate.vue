		...
		<scroll-view v-if="true" scroll-y class="data_body" :style="{height:scrollHeight}">
			...
			<view class="friend_operate">
				...
				<view style="display: flex;justify-content: space-between;">
					<view v-for="(item,index) in xProductDropPrecent" :key="index" class="charts-box" style="height: 130px;width: 45%;">
						<qiun-data-charts 
							type="arcbar" 
							:chartData="item" 
			...
			<view class="friend_operate">
				...
				<view style="display: flex;justify-content: space-between;">
					<view v-for="(item,index) in wProductDropPrecent" :key="index" class="charts-box" style="height: 130px;width: 45%;">
						<qiun-data-charts 
							type="arcbar" 
							:chartData="item" 
